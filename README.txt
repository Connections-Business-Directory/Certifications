...
Tags: business directory, certifications
...
The certifications of an entry can optionally be shown as a content block within a template or with the supplied widget int the theme's sidebar.
...
2. Search for `connections business directory certifications `.
...
1. [Download the plugin zip file](https://wordpress.org/plugins/connections-business-directory-certifications/) and save it to your computer.
2. Navigate to the `Add New` sub-page under the Plugins admin page.
3. Click the `Upload` link.
4. Select Connections Business Directory Certifications zip file from where you saved the zip file on your computer.
...
1. [Download the plugin zip file](https://wordpress.org/plugins/connections-business-directory-certifications/) and save it to your computer.
2. Extract the Connections Business Directory Certifications zip file.
3. Create a new directory named `connections-business-directory-certifications ` directory in the `../wp-content/plugins/` directory.
...
1. Add new business certifications admin page.
2. Assign certifications to business directory listing.
3. Certification Content Block.
4. Certification widget display.
